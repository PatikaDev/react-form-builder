...
export default class ReactForm extends React.Component {
  ...
  validateForm() {
    ...
    data_items.forEach((item) => {
      ...
      if (this._isInvalid(item)) {
        errors.push(`"${item.label}" alanını doldurunuz!`);
      }

      if (this.props.validateForCorrectness && this._isIncorrect(item)) {
        errors.push(`${item.label} yanlış cevaplandı!`);
      }
    });
  ...
  getCustomElement(item) {
    if (!item.component || typeof item.component !== "function") {
      ...
      if (!item.component) {
        console.error(`${item.element} kaydedilemedi.`);
      }
    }
  ...
  render() {
    ...
    const actionName = this.props.action_name
      ...
      : "Tamamla";
    const backName = this.props.back_name ? this.props.back_name : "İptal";
            ...
            <div className="btn-toolbar">
              ...
              {!this.props.hide_actions && this.props.back_action && (
                <a
                  ...
                  className="btn btn-default btn-cancel btn-big  btn-block"
                >
                  {backName}
                </a>
              )}
